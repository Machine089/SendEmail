...
sender = "Enter the sender email"
password = "Enter the sender password, if use gmail then enter application password"
recipient = "Enter the recipien email"

msg = "Enter any text you want to send"
